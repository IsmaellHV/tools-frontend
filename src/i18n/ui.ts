...
export const ui = {
  en: {
    ...
    't.pwd.exclude': 'Exclude',
    't.pwd.excludePlaceholder': 'Characters you never want, e.g. 0OIl',
    't.pwd.lookalikes': 'No look-alikes',
    't.pwd.bits': 'bits',
    't.pwd.alphabet': 'alphabet',
    't.pwd.legendLetters': 'letters',
    't.pwd.legendDigits': 'digits',
    't.pwd.legendSymbols': 'symbols',
    't.pwd.errAllExcluded': 'You excluded every available character.',
    ...
    't.imageRedact.textBadge': 'Enter to place · Esc',
  ...
  es: {
    ...
    't.pwd.exclude': 'Excluir',
    't.pwd.excludePlaceholder': 'Caracteres que nunca quieres, ej. 0OIl',
    't.pwd.lookalikes': 'Sin parecidos',
    't.pwd.bits': 'bits',
    't.pwd.alphabet': 'alfabeto',
    't.pwd.legendLetters': 'letras',
    't.pwd.legendDigits': 'dígitos',
    't.pwd.legendSymbols': 'símbolos',
    't.pwd.errAllExcluded': 'Has excluido todos los caracteres disponibles.',
    ...
    't.imageRedact.textBadge': 'Enter coloca · Esc',
